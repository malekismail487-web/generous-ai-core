...
export const OMEGA_BASELINE_REGISTRY: OmegaRegistry = Object.freeze({
  ...
  capabilities: [
    ...
    },
    {
      ...
      epistemicState: "INSUFFICIENT_EVIDENCE",
      verificationState: "UNVERIFIED",
      evidence: [r2AssuranceSpecEvidence, r2AssuranceEvaluatorEvidence],
      ...
      securityProfile: {
        ...
        securityEvidenceIds: [r2AssuranceSpecEvidence.evidenceId, r2AssuranceEvaluatorEvidence.evidenceId],
      },
      researchMaturity: "EXPERIMENT_RUN",
      relationships: [
        { kind: "VERIFIES", targetId: "Ω-CAP-WRITE-SANDBOX" },
  ...
  regressions: [
    ...
    },
    {
      ...
      expectedEvidence: ["Separately owned evaluator", "R2-A through G operational evidence", "Fresh independent E3+ evidence per required claim"],
      previousResult: "UNAVAILABLE",
      currentResult: "PROTOTYPED_34_VECTORS_NOT_OPERATIONAL",
      change: "NEW",
      confidence: 1,
      previousEvidenceIds: [],
