...
export const OMEGA_BASELINE_REGISTRY: OmegaRegistry = Object.freeze({
  ...
  plans: [
    ...
    },
    {
      ...
      maturityHistory: maturityHistory(["PROPOSED", "SPECIFIED", "PROTOTYPED", "IMPLEMENTED"], tsDebtResolvedEvidence.evidenceId),
      epistemicState: "SUPPORTED",
      verificationState: "VERIFIED",
      evidence: [directive005Evidence, tsRatchetEvidence, tsDebtResolvedEvidence],
      acceptanceCriteria: [
      ...
      securityProfile: {
        ...
        securityEvidenceIds: [tsRatchetEvidence.evidenceId, tsDebtResolvedEvidence.evidenceId],
      },
      researchMaturity: "EXPERIMENT_RUN",
      hypothesis: {
        ...
        calibrationRequirement: "Implementation is verified against the old baseline; downward baseline enforcement is a separate pending metadata commit",
      },
  ...
  capabilities: [
    ...
    },
    {
      ...
      epistemicState: "SUPPORTED",
      verificationState: "VERIFIED",
      evidence: [tsRatchetEvidence, tsDebtResolvedEvidence],
      ...
      securityProfile: securityProfile([tsRatchetEvidence.evidenceId, tsDebtResolvedEvidence.evidenceId], "Local deterministic compiler execution"),
      researchMaturity: "OPERATIONALIZED",
      relationships: [{ kind: "DEPENDS_ON", targetId: "Ω-CAP-REGISTRY-INVARIANTS" }],
  ...
  regressions: [
    ...
    },
    {
      ...
      expectedEvidence: ["Exact baseline provenance", "Live TypeScript diagnostics", "Zero new diagnostics"],
      previousResult: "UNAVAILABLE",
      currentResult: "VERIFIED_OLD_BASELINE_7_CURRENT_0_RESOLVED_7",
      change: "NEW",
      confidence: 1,
      previousEvidenceIds: [],
      currentEvidenceIds: [tsRatchetEvidence.evidenceId, tsDebtResolvedEvidence.evidenceId],
    },
    {
