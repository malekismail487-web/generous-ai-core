...
export const OMEGA_BASELINE_REGISTRY: OmegaRegistry = Object.freeze({
  ...
  plans: [
    ...
    },
    {
      ...
      implementationMappings: [],
      securityProfile: securityProfile([directiveEvidence.evidenceId], "R1 scoped repository read only"),
  ...
  capabilities: [
    ...
    },
    {
      ...
      implementationMappings: [],
      securityProfile: securityProfile([], "R1 scoped repository read only"),
      researchMaturity: "EXPERIMENT_DESIGNED",
