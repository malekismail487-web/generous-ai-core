...
try {
  ...
  `);
  await db.query('INSERT INTO auth.users(id) VALUES ($1), ($2), ($3), ($4)', [teacher, student, otherStudent, outsider]);
  ...
  await db.query(`INSERT INTO public.learning_support_plans(id, school_id, student_id, teacher_id, subject, topic, status)
    ...
    [plan, school, student, teacher, otherPlan, otherSchool, otherStudent]);
